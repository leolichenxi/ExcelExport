...
namespace ExampleFlat
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("=============================");
            Console.WriteLine( TestGlobalTemplateManager.Instance.Template.Test1Int);
            Console.WriteLine( TestTableArraysTemplateManager.Instance.Template.TestTableArrays(1).Value.Model);
