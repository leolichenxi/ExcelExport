...
public struct TestGlobalTemplate : IFlatbufferObject
{
  ...
  public static bool VerifyTestGlobalTemplate(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("", false, TestGlobalTemplateVerify.Verify); }
  ...
  public Logic.Config.TestObj_? TestObj { get { int o = __p.__offset(26); return o != 0 ? (Logic.Config.TestObj_?)(new Logic.Config.TestObj_()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  public Logic.Config.TestObj1_? TestObj1 { get { int o = __p.__offset(28); return o != 0 ? (Logic.Config.TestObj1_?)(new Logic.Config.TestObj1_()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  public Logic.Config.TestObjArray_? TestObjArrays(int j) { int o = __p.__offset(30); return o != 0 ? (Logic.Config.TestObjArray_?)(new Logic.Config.TestObjArray_()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int TestObjArraysLength { get { int o = __p.__offset(30); return o != 0 ? __p.__vector_len(o) : 0; } }
  public Logic.Config.TestObjArray1_? TestObjArray1s(int j) { int o = __p.__offset(32); return o != 0 ? (Logic.Config.TestObjArray1_?)(new Logic.Config.TestObjArray1_()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  ...
  public static Offset<Logic.Config.TestGlobalTemplate> CreateTestGlobalTemplate(FlatBufferBuilder builder,
      int test_int = 0,
      ...
      Offset<Logic.Config.TestObj_> test_objOffset = default(Offset<Logic.Config.TestObj_>),
      Offset<Logic.Config.TestObj1_> test_obj1Offset = default(Offset<Logic.Config.TestObj1_>),
  ...
  public static VectorOffset CreateTestStringArraysVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTestStringArraysVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateTestIntArraysVectorBlock(FlatBufferBuilder builder, ArraySegment<int> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTestIntArraysVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<int>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateTestFloatArraysVectorBlock(FlatBufferBuilder builder, ArraySegment<float> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTestFloatArraysVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<float>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateTestDoubleArraysVectorBlock(FlatBufferBuilder builder, ArraySegment<double> data) { builder.StartVector(8, data.Count, 8); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTestDoubleArraysVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<double>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateTestBoolArraysVectorBlock(FlatBufferBuilder builder, ArraySegment<bool> data) { builder.StartVector(1, data.Count, 1); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTestBoolArraysVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<bool>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartTestBoolArraysVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(1, numElems, 1); }
  public static void AddTestObj(FlatBufferBuilder builder, Offset<Logic.Config.TestObj_> testObjOffset) { builder.AddOffset(11, testObjOffset.Value, 0); }
  public static void AddTestObj1(FlatBufferBuilder builder, Offset<Logic.Config.TestObj1_> testObj1Offset) { builder.AddOffset(12, testObj1Offset.Value, 0); }
  ...
  public static VectorOffset CreateTestObjArraysVector(FlatBufferBuilder builder, Offset<Logic.Config.TestObjArray_>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateTestObjArraysVectorBlock(FlatBufferBuilder builder, Offset<Logic.Config.TestObjArray_>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTestObjArraysVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<Logic.Config.TestObjArray_>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTestObjArraysVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<Logic.Config.TestObjArray_>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateTestObjArray1sVector(FlatBufferBuilder builder, Offset<Logic.Config.TestObjArray1_>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateTestObjArray1sVectorBlock(FlatBufferBuilder builder, Offset<Logic.Config.TestObjArray1_>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTestObjArray1sVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<Logic.Config.TestObjArray1_>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTestObjArray1sVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<Logic.Config.TestObjArray1_>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateTestDefineFromGlobal2sVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<Position3d>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTestDefineFromGlobal2sVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<Position3d>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateTestCustomObjArraysVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<PositionArray3d>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateTestCustomObjArraysVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<PositionArray3d>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Logic.Config.TestGlobalTemplate> EndTestGlobalTemplate(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Logic.Config.TestGlobalTemplate>(o);
  }
  public static void FinishTestGlobalTemplateBuffer(FlatBufferBuilder builder, Offset<Logic.Config.TestGlobalTemplate> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedTestGlobalTemplateBuffer(FlatBufferBuilder builder, Offset<Logic.Config.TestGlobalTemplate> offset) { builder.FinishSizePrefixed(offset.Value); }
}


static public class TestGlobalTemplateVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*TestInt*/, 4 /*int*/, 4, false)
      && verifier.VerifyVectorOfStrings(tablePos, 6 /*TestStringArrays*/, false)
      && verifier.VerifyField(tablePos, 8 /*TestString1*/, 8 /*double*/, 8, false)
      && verifier.VerifyString(tablePos, 10 /*TestString*/, false)
      && verifier.VerifyField(tablePos, 12 /*TestFloat*/, 4 /*float*/, 4, false)
      && verifier.VerifyField(tablePos, 14 /*TestDouble*/, 8 /*double*/, 8, false)
      && verifier.VerifyField(tablePos, 16 /*TestBool*/, 1 /*bool*/, 1, false)
      && verifier.VerifyVectorOfData(tablePos, 18 /*TestIntArrays*/, 4 /*int*/, false)
      && verifier.VerifyVectorOfData(tablePos, 20 /*TestFloatArrays*/, 4 /*float*/, false)
      && verifier.VerifyVectorOfData(tablePos, 22 /*TestDoubleArrays*/, 8 /*double*/, false)
      && verifier.VerifyVectorOfData(tablePos, 24 /*TestBoolArrays*/, 1 /*bool*/, false)
      && verifier.VerifyTable(tablePos, 26 /*TestObj*/, Logic.Config.TestObj_Verify.Verify, false)
      && verifier.VerifyTable(tablePos, 28 /*TestObj1*/, Logic.Config.TestObj1_Verify.Verify, false)
      && verifier.VerifyVectorOfTables(tablePos, 30 /*TestObjArrays*/, Logic.Config.TestObjArray_Verify.Verify, false)
      && verifier.VerifyVectorOfTables(tablePos, 32 /*TestObjArray1s*/, Logic.Config.TestObjArray1_Verify.Verify, false)
      && verifier.VerifyTable(tablePos, 34 /*TestDefineFromGlobal*/, Position3dVerify.Verify, false)
      && verifier.VerifyVectorOfTables(tablePos, 36 /*TestDefineFromGlobal2s*/, Position3dVerify.Verify, false)
      && verifier.VerifyTable(tablePos, 38 /*TestCustomObj*/, PositionArray3dVerify.Verify, false)
      && verifier.VerifyVectorOfTables(tablePos, 40 /*TestCustomObjArrays*/, PositionArray3dVerify.Verify, false)
      && verifier.VerifyField(tablePos, 42 /*Test1Int*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 44 /*TestInt1*/, 4 /*int*/, 4, false)
...
public struct TestObj_ : IFlatbufferObject
{
  ...
  public static Offset<Logic.Config.TestObj_> CreateTestObj_(FlatBufferBuilder builder,
      int a = 0,
      float b = 0.0f,
      bool c = false) {
  ...
  public static Offset<Logic.Config.TestObj_> EndTestObj_(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Logic.Config.TestObj_>(o);
  }
}


static public class TestObj_Verify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*A*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 6 /*B*/, 4 /*float*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*C*/, 1 /*bool*/, 1, false)
      && verifier.VerifyTableEnd(tablePos);
  }
}
public struct TestObj1_ : IFlatbufferObject
{
  ...
  public static Offset<Logic.Config.TestObj1_> CreateTestObj1_(FlatBufferBuilder builder,
      int a = 0,
  ...
  public static VectorOffset CreateBsVectorBlock(FlatBufferBuilder builder, ArraySegment<float> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateBsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<float>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<Logic.Config.TestObj1_> EndTestObj1_(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Logic.Config.TestObj1_>(o);
  }
}


static public class TestObj1_Verify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*A*/, 4 /*int*/, 4, false)
      && verifier.VerifyVectorOfData(tablePos, 6 /*Bs*/, 4 /*float*/, false)
      && verifier.VerifyField(tablePos, 8 /*V*/, 1 /*bool*/, 1, false)
      && verifier.VerifyTableEnd(tablePos);
  }
}
public struct TestObjArray_ : IFlatbufferObject
{
  ...
  public static Offset<Logic.Config.TestObjArray_> CreateTestObjArray_(FlatBufferBuilder builder,
      int a = 0,
      int b = 0,
      int c = 0) {
    builder.StartTable(3);
  ...
  public static Offset<Logic.Config.TestObjArray_> EndTestObjArray_(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Logic.Config.TestObjArray_>(o);
  }
}


static public class TestObjArray_Verify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*C*/, 4 /*int*/, 4, false)
      && verifier.VerifyTableEnd(tablePos);
  }
}
public struct TestObjArray1_ : IFlatbufferObject
{
  ...
  public static Offset<Logic.Config.TestObjArray1_> CreateTestObjArray1_(FlatBufferBuilder builder,
      int a = 0,
      VectorOffset bsOffset = default(VectorOffset)) {
  ...
  public static VectorOffset CreateBsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<float>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartBsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<Logic.Config.TestObjArray1_> EndTestObjArray1_(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Logic.Config.TestObjArray1_>(o);
  }
}


static public class TestObjArray1_Verify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
