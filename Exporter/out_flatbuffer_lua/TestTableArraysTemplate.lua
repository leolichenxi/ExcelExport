...
function TestTableArraysTemplate_mt:TestTypes(j)
    ...
    if o ~= 0 then
        ...
        local obj = require('Config.TestType_').New()
        obj:Init(self.view.bytes, x)
        return obj
    end
end
...
function TestTableArraysTemplate_mt:LinkId()
...
function TestTableArraysTemplate_mt:MachineTypes(j)
...
function TestTableArraysTemplate_mt:MachineTypesLength()
    local o = self.view:Offset(18)
    if o ~= 0 then
        return self.view:VectorLen(o)
    end
...
function TestTableArraysTemplate.Start(builder) builder:StartObject(9) end
...
function TestTableArraysTemplate.AddMapType(builder, mapType) builder:PrependUOffsetTRelativeSlot(8, mapType, 0) end
